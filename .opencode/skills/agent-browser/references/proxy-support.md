...
```bash
# Via CLI flag
npx agent-browser --proxy "http://proxy.example.com:8080" open https://example.com
...
```bash
# Via CLI flag
npx agent-browser --proxy "http://proxy.example.com:8080" --proxy-bypass "localhost,*.internal.com" open https://example.com
