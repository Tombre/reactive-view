...
|-----------|---------|-----------------|
| **Target URL** | _(required)_ | `reactiveview.com`, `http://localhost:3000` |
| **Session name** | Slugified domain (e.g., `reactiveview.com` reactiveview `reactiveview-com`) | `--session my-session` |
| **Output directory** | `./dogfood-output/` | `Output directory: /tmp/qa` |
| **Scope** | Full app | `Focus on the billing page` |
| **Authentication** | None | `Sign in to user@example.com` |

If the user says something like "dogfood reactiveview.com", start immediately with defaults. Do not ask clarifying questions unless authentication is mentioned but credentials are missing.
