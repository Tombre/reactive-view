...
export default function HomePage() {
  ...
  return (
    <div style={{ "font-family": "system-ui, sans-serif", padding: "40px", "max-width": "800px", margin: "0 auto" }}>
      ...
      <p>
        This page is rendered by <strong>SolidJS</strong> with server-side rendering,
        powered by your <strong>Rails</strong> backend.
      </p>
      ...
      <div style={{ "margin-top": "30px", color: "#666" }}>
        <h3>How It Works</h3>
        <ul>
          <li>Pages are defined as TSX files in <code>app/pages/</code></li>
          <li>Data is loaded via Ruby loaders (<code>*.loader.rb</code>)</li>
