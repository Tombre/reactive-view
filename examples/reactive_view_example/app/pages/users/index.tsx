  ...
  return (
    <div style={{ "font-family": "system-ui, sans-serif", padding: "40px", "max-width": "800px", margin: "0 auto" }}>
      <nav style={{ 
        ...
        <A href="/users" style={{ "margin-right": "16px", "font-weight": "bold" }}>Users</A>
      ...
      <p>
        This page demonstrates loading data from a Rails loader.
        The user data comes from <code>app/pages/users/index.loader.rb</code>.
      </p>
      ...
      <div style={{ "margin-top": "30px", background: "#f9fafb", padding: "16px", "border-radius": "8px" }}>
        <h3>Loader Code</h3>
        <pre style={{ 
          background: "#1f2937", 
          color: "#e5e7eb", 
