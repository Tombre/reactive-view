...
module ReactiveView
  module Types
    ...
    #
    # This generator uses TypeScript module augmentation to extend the
    # @reactive-view/core package's LoaderDataMap interface with project-specific
    # loader types. This approach is similar to how Prisma generates types.
    #
    # @example Generated output
    #   // Auto-generated by ReactiveView - DO NOT EDIT
    #   import "@reactive-view/core";
    #
    #   interface UsersIdLoaderData {
    #     id: number;
    #     name: string;
    #   }
    #
    ...
    class TypescriptGenerator
      OUTPUT_FILE = 'types/loader-data.d.ts'
