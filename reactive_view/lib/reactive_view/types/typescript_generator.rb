    ...
    class TypescriptGenerator
      ...
      def build_loader_file(loader)
        ...
        <<~TYPESCRIPT
          ...
          import { createLoaderQuery } from "@reactive-view/core";
          import { createAsync, useParams } from "@solidjs/router";
          import type { Accessor } from "solid-js";

          #{generate_nested_interfaces(loader[:schema], 'LoaderData')}
           ...
           * @param params - Route parameters#{param_names.empty? ? '' : " (#{param_names.join(', ')})"}
           */
