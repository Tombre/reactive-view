 ...
 */
export declare function createMutation<TResult = unknown, TInput = MutationJsonInput>(loaderPath: string, mutationName?: string): import("@solidjs/router").Action<[input: TInput | FormData], MutationResult<TResult>, [input: TInput | FormData]>;
/**
